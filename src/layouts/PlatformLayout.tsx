...
export default function PlatformLayout() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 platform-gradient text-primary-foreground flex flex-col transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-3 border-t border-sidebar-border">
          <Link
            to="/platform/login"
            className="flex items-center gap-3 px-3 py-2.5 text-sm text-sidebar-foreground hover:bg-sidebar-accent/50 rounded-lg"
          >
